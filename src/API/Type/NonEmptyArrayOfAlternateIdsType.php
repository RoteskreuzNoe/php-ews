...
class NonEmptyArrayOfAlternateIdsType extends Type
{
    ...
    /**
     * @var \rklandesverband\ews\API\Type\AlternateIdType[]
     */
    protected $alternateId = null;

    /**
     * @var \rklandesverband\ews\API\Type\AlternatePublicFolderIdType[]
     */
    protected $alternatePublicFolderId = null;

    /**
     * @var \rklandesverband\ews\API\Type\AlternatePublicFolderItemIdType[]
     */
