 ...
 *
 * @method FindMailboxStatisticsByKeywordsType addMailboxes(\rklandesverband\ews\API\Type\UserMailboxType $mailboxes)
 * @method \rklandesverband\ews\API\Type\UserMailboxType[] getMailboxes()
