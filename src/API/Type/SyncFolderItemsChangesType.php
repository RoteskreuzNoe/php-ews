...
class SyncFolderItemsChangesType extends Type
{
    ...
    /**
     * @var \rklandesverband\ews\API\Type\SyncFolderItemsCreateOrUpdateType[]
     */
    ...
    /**
     * @var \rklandesverband\ews\API\Type\SyncFolderItemsDeleteType[]
     */
    protected $delete = null;

    /**
     * @var \rklandesverband\ews\API\Type\SyncFolderItemsReadFlagType[]
     */
